...
// err:domain:reason problem codes (docs/conventions.md). The mapping each
...
var (
	...
	ErrUnsupportedClientIDPrefix = errors.New("oid4vp: unsupported client_id prefix")                                   // WP-08 decision: x509_san_dns only in v1
	...
	// Response processing (T-08.5/6/7). All map to
	...
	// SessionTranscript delegation (T-08.7).
...
// untrusted text (never logged raw next to attribute data, hard rule 3).
